...
import mk.springframework.mkbeerservice.web.controller.NotFoundException;
import mk.springframework.mkbeerservice.web.mappers.BeerMapper;
import mk.springframework.brewery.model.BeerDto;
import mk.springframework.brewery.model.BeerPagedList;
...
public class BeerServiceImpl implements BeerService {
    ...
    public BeerPagedList listBeers(String beerName, BeerStyleEnum beerStyle,
        ...
        log.debug("Called BeerServiceImpl.listBeers...");
    ...
    public BeerDto getById(UUID beerId, Boolean showInventoryOnHand) {
        ...
        log.debug("Called BeerServiceImpl.getById...");
